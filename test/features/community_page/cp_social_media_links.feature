Feature: Community Page - Social media links check

  As a user on the DADI.cloud Community page they should be able to view the links for the socal media channels
  in the header
