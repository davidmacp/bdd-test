...
defineSupportCode(function ({ Then }) {
  Then(/^there should be 18 Core Team member boxes visible$/, () => {
    ...
    //
    // expect(teamBoxes.value.length).to.equal(18)
    checkElementCount('body > main > div > div:nth-child(2) > div:nth-child(n)', 18)
  })
  ...
  Then(/^there should be 18 Core Team member images visible$/, () => {
    ...
    //
    // expect(teamImages.value.length).to.equal(18)
    checkElementCount('body > main > div > div:nth-child(2) > div:nth-child(n) > a > img', 18)
  })
  ...
  Then(/^there should be 18 Core Team member names visible$/, () => {
    ...
    //
    // expect(teamNames.value.length).to.equal(18)
    checkElementCount('body > main > div > div:nth-child(2) > div:nth-child(n) > a > div > h2', 18)
  })
  ...
  Then(/^there should be 18 Core Team member titles visible$/, () => {
    ...
    //
    // expect(memberTitles.value.length).to.equal(18)
    checkElementCount('body > main > div > div:nth-child(2) > div:nth-child(n) > a > div > p', 18)
  })
})
