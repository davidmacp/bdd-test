...
Background:
  ...
  When I scroll to element "body > main.mb--x2 > div.cnt > div.hdr > h3 > span"

Scenario: Check Latest Article title is visible
  Then I expect that element "body > main.mb--x2 > div.cnt > div.hdr > h3 > span" matches the text "LATEST ARTICLES"
