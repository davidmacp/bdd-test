Feature: Network Page - Social media links check

  As a user on the DADI.cloud Network page they should be able to view the links for the socal media channels
  in the header

Scenario: Check social media links are present
  Given I have a screen that is 1310 by 768 pixels
  And I open the url "http://beta2.dadi.cloud/en/network"
