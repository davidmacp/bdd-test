...
module.exports = function () {
  this.Then(/^there should be at least 1 Advisor box visible$/, () => {
  ...
  this.Then(/^there should be at least 1 Advisor image visible$/, () => {
  ...
  this.Then(/^there should be at least 1 Advisor name visible$/, () => {
