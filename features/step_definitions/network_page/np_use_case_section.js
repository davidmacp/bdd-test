...
module.exports = function() {
  ...
  this.Then(/^there should be 11 image icons visible$/, () => {
    const image = browser.elements('body > main > div > div:nth-child(5) > div:nth-child(n) > a > div.box__inner > img')
    // console.log(image)
  ...
  this.Then(/^there should be 11 header titles visible$/, () => {
    const boxTitle = browser.elements('body > main > div > div:nth-child(5) > div:nth-child(n) > a > div.box__inner > h2')
  ...
  this.Then(/^there should be 11 box descriptions visible$/, () => {
    const boxDescription = browser.elements('body > main > div > div:nth-child(5) > div:nth-child(n) > a > div.box__inner > p')
  ...
  this.Then(/^there should be 11 "Learn more" links visible$/, () => {
    const learnMore = browser.elements('body > main > div > div:nth-child(5) > div:nth-child(n) > a > div.box__footer > span')
