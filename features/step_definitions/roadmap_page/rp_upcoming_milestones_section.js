...
module.exports = function () {
  ...
  this.Then(/^there should be 4 primary badges visible$/, () => {
    const primaryBadges = browser.elements('body > header > div > div.grid > div.col > article > div.box__inner > div.badge > div.badge__primary')
  ...
  this.Then(/^there should be 4 secondary badges visible$/, () => {
    const secondaryBadges = browser.elements('body > header > div > div.grid > div.col > article > div.box__inner > div.badge > div.badge__secondary')
  ...
  this.Then(/^there should be 4 article titles visible$/, () => {
    const articleTitles = browser.elements('body > header > div > div.grid > div.col > article > div.box__inner > h2')
  ...
  this.Then(/^4 article descriptions are visible$/, () => {
    const articleDescription = browser.elements('body > header > div > div.grid > div.col > article > div.box__inner > div.mb > p')
  ...
  this.Then(/^there should be 4 milestone dates$/, () => {
    const articleDate = browser.elements('body > header > div > div.grid > div.col > article > div.box__footer > time')
